 ...
 * Sliding Puzzle
 *
 * On a 2 x 3 board, there are 5 tiles represented by the integers 1 through 5, and an
 * empty square represented by 0.
 *
...
const slidingPuzzle = module.exports = function(board) {
  return 0;
};
